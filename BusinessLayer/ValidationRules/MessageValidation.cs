...
namespace BusinessLayer.ValidationRules
{
    public class MessageValidation : AbstractValidator<Message>
    {
        public MessageValidation()
        {
            ...
            RuleFor(x => x.MessageDetails).NotEmpty().WithMessage("İçerik Boş Bırakılamaz").MinimumLength(100).WithMessage("İçerik En Az 100 Karekter Yazılabilir").MaximumLength(100000).WithMessage("İçerik En Fazla 100000 Karekter Yazılabilir");
